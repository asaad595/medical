...
export  const NavbarMenu =  ({session}:{session:any})=> {
      ...
      <nav className="mx-auto flex w-full max-w-7xl items-center justify-between py-2 px-6 lg:px-8 border-blue-500 border-b"  aria-label="Global">
        ...
        { session?.user ?(
          <div className="hidden lg:flex lg:flex-1 lg:justify-end ">
             <Button onClick={() => signOut()} className="text-sm font-semibold leading-6  bg-white
            ...
            <div className="hidden lg:flex lg:flex-1 lg:justify-end ">
            <Link href="/doctors/login" className="text-sm font-semibold leading-6  bg-white
             py-2 px-4 rounded-lg text-gray-700">
